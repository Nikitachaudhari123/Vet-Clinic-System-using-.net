...
namespace Vet_Clinic.Controllers
{
    public class PetsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Pets.Include(p => p.VetDoctor);
        ...
        {
            ViewData["VetDoctorId"] = new SelectList(_context.VetDoctors, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,MicrochipId,Name,Species,VetDoctorId")] Pet pet)
        {
            ...
            ViewData["VetDoctorId"] = new SelectList(_context.VetDoctors, "Id", "Id", pet.VetDoctorId);
            return View(pet);
        }
